...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference("Keyword.count") do
      post keywords_url, params: { keyword: { name: @keyword.name, subcategory_id: @keyword.subcategory_id } }, as: :json
    end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { name: @keyword.name, subcategory_id: @keyword.subcategory_id } }, as: :json
    assert_response :success
  end
